...
if __name__ == '__main__':
    ...
    for k_fold in range(num_folds):
        ...
        (x_train, y_train), (x_valid, y_valid), _ = load_training_data(task_idx=3,output_size=224,num_partitions=num_folds,idx_partition=k_fold)
